...
using SimulationBilet16MPA201.ViewModels.AccountViewModels;
...
public class AccountController : Controller
{
    ...
    public AccountController(SimulationDbContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, RoleManager<IdentityRole> roleManager)
    {
        _context = context;
